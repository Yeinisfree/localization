...
class RIST():
    ...
    def matching(self , i) -> None:
        ...
        E_update_radius_prev = self.rm.E_update_radius
        E_update_radius_max = 0
        ...
        for j in self.__db_search_index:
            ...
            ##
            new_img_matches, new_matches, rm_R, rm_t, E_update_radius_temp, F_empty = self.rm.radius_match(self.__query_imgs[i], db_img, E_update_radius_prev)
            ...
            if self.__rm_max_match_length < len(new_matches):
                ...
                E_update_radius_max = E_update_radius_temp
            ...
            self.__answer_translation_temp = self.rm.get_translation(rm_t, self.__answer_translation, self.track.get_flags_val(), self.track.get_direction_val()) # T_flags
        ...
        self.rm.E_update_radius = E_update_radius_max
