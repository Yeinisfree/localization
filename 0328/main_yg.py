...
# new
# part2 num = 44,  rmvoutlier_th:0.8,  angle_th:120
...
for i in range(0, num_images):
    # img = cv2.imread("/home/aaron/study/data/230317_test/part2_undistort/undistort_" + str(i) + ".jpg")
    img = cv2.imread("/home/cgv/0306_0325/dataset/Part2_undistort/undistort_" + str(i) + ".jpg")
    # img = cv2.imread("/home/cgv/0316yg/test2/test/dataset/230214_test/B/B" + str(i) + ".jpg")
    images.append(img)
...
for i in range(1, num_images):
    ...
    src_pts, dst_pts = track.remove_outliers(src_pts, dst_pts, rmv_th)
    ...
    cv2.imwrite('./img_match/viz' + str(i-1) +'.jpg', res)
