...
class RIST():
    ...
    def matching(self , i) -> None:
        ...
        for j in self.__db_search_index:
            ...
            ##
            new_img_matches, new_matches, rm_R, rm_t = self.rm.radius_match(self.__query_imgs[i], db_img, E_update_radius_prev)
            ...
            self.__answer_translation_temp = self.rm.get_translation(self.rm.t, self.__answer_translation, self.track.get_flags_val(), self.track.get_direction_val()) # T_flags
