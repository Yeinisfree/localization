...
import time
import os
import tracking_bias_0416_part3 as tracking
# import tracking_0416_part3 as tracking

### setting ###
# 1. 촬영한 DB의 이미지들을 확인하여 section별 이미지의 수를 파악
# 2. 'save_DBs_pose' 안 '# section & db pose' 수정          quantization 끄고 하는 것 추천
# 3. tracking.py --> get_translation_Essential 안 '이전 포즈 += translation' 파트에서 translation = t 부분 결과를 확인하며 점이 어디가는지 확인하고 수정
# 4. scale 수정 + '2.' 수정         quantization 끄고 하는 것 추천c
# 5. decision_axis 수정
...
def decision_axis(cur_db_idx, __section1, __section2, __section3, __section4, __ax):
    ## __ax == 0 --> x-axis
    ## __ax == 1 --> y-axis
...
# db_path = "/home/cgv/0328/dataset/db_Part3/"
db_path = "/home/cgv/0328/dataset/db_Part3_0417/"
qpath = "/home/cgv/0328/part3_AF_0328/test"
...
for i in range(1, num_images):
    ...
    if(re == 1):
        ...
        __ax = decision_axis(cur_db_idx, __section1, __section2, __section3, __section4, __ax)
    ...
    plt.scatter(cur_loc_db[0], cur_loc_db[1], 30, "black", zorder = 3) # only quan.
