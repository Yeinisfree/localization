...
def Quantization(tracking_pose, __DBs_pose, __num_db_imgs, cur_loc_db, DB_idx_list, cur_db_idx, __range_x, __range_y, __ax):
...
for i in range(1, num_images):
    ...
    cur_loc_db, DB_idx_list, cur_db_idx = Quantization(cam_pos.copy(), DBs_pose, num_db_imgs, cur_loc_db, DB_idx_list, cur_db_idx, __range_x, __range_y, __ax)
    ...
    # real estimated pose <-- after quan. + recalib.
