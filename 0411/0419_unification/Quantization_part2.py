...
import time
import os
# import tracking_bias_part2 as tracking
import tracking_bias_part2_0423 as tracking
    ...
    for i in __DB_idx_list:
        ...
        for m, n in matches:
            if(m.distance < dist_th):
                if(m.distance < nndr * n.distance): # (nndr - 0.3) * n.distance < m.distance and 
...
db_path = "/home/cgv/0328/dataset/db_Part2_0417/"
qpath = "/home/cgv/0328/part2_AF_0328/test"
save_path = "/home/cgv/0411/matching_result/part2/"
