...
import time
import os
import tracking_bias_0418_new_part2_no_initialization as tracking
...
def save_DBs_pose(db_path, q_shape, __scale_x, __scale_y):
...
# DB 사진 저장, 좌표 저장
db_imgs_list, db_imgs_list_name, num_db_imgs, DBs_pose = save_DBs_pose(db_path, images[0].shape, __scale_x, __scale_y)
...
for i in range(1, num_images):
    ...
    # if(prev_rot_suspectation != 1 or rot_suspectation != 1) and __ax != 5:
